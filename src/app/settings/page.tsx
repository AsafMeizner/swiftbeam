...
export default function SettingsPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50/30 p-4 md:p-8 flex items-center justify-center">
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50/30 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <p className="text-gray-600 text-lg">Customize your SwiftBeam experience</p>
        </motion.div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Automatically appear to nearby devices</p>
                    </div>
                    <Switch
              ...
              <Card className="border-0 shadow-lg bg-white/90 backdrop-blur-sm">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="text-sm space-y-2">
                    ...
                    <ul className="text-gray-600 space-y-1 pl-6 text-xs">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Get notified about transfers</p>
                    </div>
                    <Switch
